...
INPUT_PATH = BASE_DIR / "refrigerator_data.tsv"
OUTPUT_DIR = BASE_DIR / "refrigerator_output"
PKL_PATH = OUTPUT_DIR / "refrigerator_cycles_raw_data.pkl"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Refrigerator clustering")
...
def main() -> None:
    args = parse_args()
    params = choose_config("refrigerator", custom_path_arg=args.config)
    ...
    run_cycle_pipeline(
        ...
        pkl_path=PKL_PATH,
        chart_title_prefix="refrigerator",
        params=params,
        exact_k=exact_k,
    )
