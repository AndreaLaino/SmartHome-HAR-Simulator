...
INPUT_PATH = BASE_DIR / "dishwasher_data.tsv"
OUTPUT_DIR = BASE_DIR / "dishwasher_output"
PKL_PATH = OUTPUT_DIR / "cycles_raw_data.pkl"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dishwasher clustering")
...
def main() -> None:
    args = parse_args()
    params = choose_config("dishwasher", custom_path_arg=args.config)
